...
\textbf{Dosen:} & Iwan Njoto Sandjaja & & & & \textbf{Waktu:} & Rabu 07:30 -- 10:30 \\
\textbf{Email:} &  \href{mailto:iwanns@petra.ac.id}{iwanns@petra.ac.id} & & & & \textbf{Tempat:} & Puskom T Lab E
\end{tabular}
\end{minipage}
\rule{6in}{0.4pt}
\end{center}
...
\item Eric S. Raymond, {\textit{The Cathedral and The Bazaar: Musing on Linux and Open Source by Accidental Revolutionary}}, O'Reilly Media, 1999 (http://www.catb.org/esr/writings/cathedral-bazaar/)
\item Scott Chacon and Ben Straub, {\textit{Pro Git}}, Apress, 2014. (https://git-scm.com/book/en/v2)
\item Christopher Negus, {\textit{Linux Bible 9th Ed.}}, Wiley, 2015.
\item William Shotts, {\textit{The Linux Command Line}},  No Starch Press, 2012. (http://linuxcommand.org/tlcl.php)
\item Benjamin S. Blanchard and Wolter J. Fabrycky, {\textit{Systems Engineering and Analysis 5th Ed.}}, Pearson Prentice Hall, 2010.
\item Thomas A. Limoncelli, Christina J. Hogan and Strata R. Chalup, {\textit{The Practice of System and Network Administration 2nd Ed.}}, Pearson Education Inc., 2007.
\item Kenneth Reitz and Tanya Schlusser, {\textit{The Hitchhiker's Guide to Python: Best Practices for Development 1st Ed}},  O'Reilly Media, 2016. (http://docs.python-guide.org/en/latest/)
\end{itemize}
